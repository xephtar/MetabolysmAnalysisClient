<template>
  <section>
    ...
    <b-table
      ...
      @details-open="(row) => $buefy.toast.open(`Expanded ${row.disease}`)"
      ...
      <b-table-column field="disease" label="Disease Name" width="150px" sortable v-slot="props">
      ...
      <template style="width: available"  slot="detail" slot-scope="props">
        ...
        <b-table
          ...
          <b-table-column field="pathway" centered label="Pathway" width="200" :td-attrs="columnTdAttrs" numeric v-slot="props">
            {{ props.row.pathway }}
          </b-table-column>
...
const data = require('../../public/data-sources/disease.json')
...
export default {
  ...
  data () {
    return {
      ...
      useTransition: false,
      columnsVisible: {
        pathway: { title: 'Pathway', display: true },
